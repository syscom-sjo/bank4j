    ...
    void test_with_all_fields() {
        ...
        for (int i = 1; i < 10; i++) {
            transactions.add(Bank.simpleTransaction()
                    ...
                    .remittanceInformationStructured(Collections.singleton(Bank.simpleCreditorReferenceInformation()
